...
public class BarbadosFlagPanel extends GuessingPanel {

	public BarbadosFlagPanel() {
		super(Gamemode.HARD ,"Bahamas", "Barbados", "Dominican", "ST. Lucia");
		...
		setLoggerInfo("Barbados");
	}

	@Override
	protected String imagePath() {
		return "/Images/FlagHard/Barbados.png";
	}
