...
public class GrenadaFlagPanel extends GuessingPanel {

	public GrenadaFlagPanel() {
		super(Gamemode.HARD ,"Georgia", "Grenada", "Namibia", "Gabon");
		...
		setLoggerInfo("Grenada");
	}

	@Override
	protected String imagePath() {
		return "/Images/FlagHard/Grenada.png";
	}
