...
public class LesothoFlagPanel extends GuessingPanel {

	public LesothoFlagPanel() {
		super(Gamemode.HARD ,"Zimbabwe", "Togo", "Kiribati", "Lesotho");
		...
		setLoggerInfo("Lesotho");
	}

	@Override
	protected String imagePath() {
		return "/Images/FlagHard/Lesotho.png";
	}
