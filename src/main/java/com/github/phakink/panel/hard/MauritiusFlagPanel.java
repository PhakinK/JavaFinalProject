...
public class MauritiusFlagPanel extends GuessingPanel {

	public MauritiusFlagPanel() {
		super(Gamemode.HARD ,"Yemen", "Mauritius", "Madagascar", "Mali");
		...
		setLoggerInfo("Mauritius");
	}

	@Override
	protected String imagePath() {
		return "/Images/FlagHard/Mauritius.png";
	}
